...
const Features = () => {
  ...
  useEffect(() => {
    setIsClient(true); // Ensure this is only set on client-side
  }, []);
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <ul className="space-y-6">
            {features.map((feature, index) => (
              <motion.li
                ...
                className={`cursor-pointer p-6 rounded-lg shadow-lg border transition-all ease-in-out duration-300 ${index === selectedFeatureIndex
        ...
        >
          {selectedFeature === null ? (
            <Image
              src="/Images/defaultimg.jpg" // Ensure this path is correct
            ...
            <>
              ...
              <div className="overflow-hidden rounded-xl mt-6">
                <Image
                  src={selectedFeature.image} // Ensure this path is correct
